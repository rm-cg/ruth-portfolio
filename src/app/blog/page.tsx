import { Column, Heading, Row, Line, Media, Text } from "@once-ui-system/core";
...
// ============================================================================
// 📸 THE MAGIC ARRAYS (LINTER-PROOF OBJECTS)
// Simply paste your Cloudinary image links inside the empty src: "" quotes!
// ============================================================================
  ...
  return (
    <Column maxWidth="m" fillWidth gap="xl" horizontal="center" paddingBottom="xl">
      ...
      <Column id="gdgoc" fillWidth gap="m" paddingTop="l" horizontal="center">
        ...
        <Row fillWidth gap="12" wrap paddingTop="l" horizontal="center">
          {gdgPhotos.map((photo) => (
            <Row key={photo.id} border="neutral-medium" background="neutral-alpha-weak" padding="4" radius="m" minWidth={180} height={135}>
              {photo.src ? (
                <Media enlarge radius="s" alt={photo.id} src={photo.src} style={{ objectFit: "cover" } as CSSProperties} />
              ) : (
                <Column fillWidth fillHeight background="neutral-alpha-medium" radius="s" vertical="center" horizontal="center">
