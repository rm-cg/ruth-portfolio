...
const about = {
  ...
  intro: {
    display: true,
    title: "Introduction",
    // FIXED: Converted to a pure string to stop JSX element errors!
    ...
    experiences: [
      {
        ...
        // FIXED: Stripped out React.Fragment and converted to pure strings!
        achievements: [
  ...
  studies: {
    ...
    institutions: [
      ...
      },
     {
        ...
        <i>
          Graduated SHS with High Honors (2023)</i><br />
...
const gallery = {
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Data Campus to Corporate Training - RR Donnelley",
      orientation: "horizontal",
    },
        {
